...
export default function OTP() {
  ...
  // NEW: auto-verify when 6 digits entered
  useEffect(() => {
    ...
    <SafeAreaView style={styles.container}>
      <KeyboardAvoidingView behavior={Platform.select({ ios: "padding", android: undefined })} style={styles.flex}>
        <View style={styles.content}>
          ...
          {/* NEW: hint caption and error message */}
          <Text style={styles.captionText}>Hint: Enter 123456</Text>
...
const styles = StyleSheet.create({
  ...
  // NEW: styles for hint and error
  captionText: { marginTop: 4, color: MUTED, fontSize: 12 },
  errorText: { marginTop: 6, color: ERROR, fontSize: 13, fontWeight: "600" },
